...
export default async function Home() {
  ...
  try {
    ...
    if (results[0].status === "fulfilled") {
      courses = results[0].value.data || [];
    } else {
      console.error("Error fetching courses:", results[0].reason);
    }

    if (results[1].status === "fulfilled") {
      stats = results[1].value.data;
    } else {
      console.error("Error fetching stats:", results[1].reason);
    }

    if (results[2].status === "fulfilled") {
      user = results[2].value;
    } else {
      console.error("Error fetching user:", results[2].reason);
    }
  } catch (error) {
      ...
      <main className="relative z-10">
        <section className="px-6 lg:px-12 pt-16 pb-24 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Join Naga Academy and learn from expertly crafted courses,
            ...
            {[
              {
                ...
                content:
                  "Naga's teaching style is incredible. I went from knowing nothing to landing my first dev job in 6 months!",
                avatar: "🧑‍💻",
              },
              {
                name: "Sarah Miller",
        ...
        <footer className="px-6 lg:px-12 py-12 border-t border-zinc-800/50 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold">Naga Academy</span>
            </div>
            ...
            <p className="text-sm text-zinc-600">
              © 2024 Naga Academy. All rights reserved.
            </p>
          </div>
        </footer>
      </main>
